...
public class FinanceRequests {
    ...
    public static void createAccount(UUID id, long starterCents) {
        ...
        System.out.println("[FinanceRequests] Created dummy account for " + id + " with " + starterCents + " cents");
    }
    ...
    public static void setMain(UUID id, long cents) {
        ...
        System.out.println("[FinanceRequests] (Dummy) Updated main balance for " + id + ": " + cents);
    }

    public static void setSavings(UUID id, long cents) {
        savingsBalances.put(id, Math.max(0, cents));
        System.out.println("[FinanceRequests] (Dummy) Updated savings for " + id + ": " + cents);
    }
    ...
    public static boolean transferMain(UUID from, UUID to, long cents) {
        ...
        System.out.println("[FinanceRequests] (Dummy) Transfer " + cents + " cents from " + from + " → " + to);
        return true;
    }
